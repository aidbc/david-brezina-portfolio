  ...
  cs: [
    {
      ...
      text: "Vedl jsem product discovery a delivery na klientských projektech ve fintechu a wealth managementu. Jako Wealth Management Lead jsem se podílel také na strategii, pre-sales a práci s klienty. Interně jsem rozvíjel praktické využití AI v product delivery a podporoval Product Ownery v týmu.",
      links: [
    ...
    },
    {
      ...
      meta: "freelance · Praha",
      text: "Ve spolupráci s CPO jsem převzal každodenní product ownership open-banking platformy a zaměřil se na zlepšení fungování vývojového týmu. Doručili jsme novou klientskou administraci a podpořili expanzi na Slovensko, do Maďarska a Rumunska.",
    },
    {
      company: "Shoptet",
      role: "Product Manager / Product Owner, Shoptet Pay",
      period: "listopad 2021 – prosinec 2022",
      meta: "contract · Praha",
      text: "Podílel jsem se na vzniku Shoptet Pay, platebního řešení od Adyen integrovaného přímo do administrace Shoptetu. Vedl jsem product discovery a delivery v open bankingu a automatickém párování plateb. S týmem jsme spustili online platební bránu a rozšířili služby pro správu plateb.",
      links: ["shoptet-pay"],
    },
    {
      ...
      meta: "freelance · Praha",
      text: "Pracoval jsem na early-stage digitálních produktech a venture projektech. Ve Fairo jsem vedl produktový tým pro accounting, bookkeeping a tax reporting. Jako Project CEO jsem od prvního konceptu ke spuštění vybudoval Digitální dílnu pro živnostníky a malé firmy.",
  ...
  en: [
    {
      ...
      text: "I led product discovery and delivery on client projects across fintech and wealth management. As Wealth Management Lead, I also contributed to strategy, pre-sales and client work. Internally, I developed the practical use of AI in product delivery and supported Product Owners in the team.",
      links: [
        "across-private-investments-app",
        "wealth-management-product-discovery",
        "stealth-trading-app",
    ...
    },
    {
      ...
      meta: "freelance · Prague",
      text: "In cooperation with the CPO, I took over the day-to-day product ownership of an open-banking platform and focused on improving how the development team operated. We delivered a new client administration portal and supported expansion into Slovakia, Hungary and Romania.",
    },
    {
      company: "Shoptet",
      role: "Product Manager / Product Owner, Shoptet Pay",
      ...
      text: "I contributed to the creation of Shoptet Pay, an Adyen payment solution integrated directly into Shoptet's merchant administration. I led product discovery and delivery in open banking and automated payment matching. Together with the team, we launched the online payment gateway and expanded its payment-management services.",
      links: ["shoptet-pay"],
    },
    {
      company: "Creative Dock",
      ...
      meta: "freelance · Prague",
      text: "I worked on early-stage digital products and venture projects. At Fairo, I led a product team responsible for accounting, bookkeeping and tax reporting. As Project CEO, I built Digitální dílna for sole traders and small businesses from initial concept through launch.",
      links: ["fairo", "digitalni-dilna"],
    },
    {
      company: "Česká spořitelna",
...
export const ui = {
  cs: {
    ...
    heroText: "Z nejasného nápadu pomáhám vytvořit produkt, který má smysl postavit — od discovery přes MVP a delivery až po launch.",
    ...
    groups: [
      ...
      ["Jazyky", "Čeština — rodilý mluvčí · Angličtina — pokročilá pracovní úroveň (B2/C1)"],
      ["Vzdělání", "Univerzita Hradec Králové — Ing. / Informační management (2004–2010) · Universidad Politécnica de Madrid — Erasmus, Informační management (2009–2010)"],
      ["Certifikace", "Professional Scrum Product Owner I — Scrum.org (2022) · PRINCE2 Practitioner (2015)"],
      ["Nástroje", "Jira · Confluence · Figma · Miro · Slack · Mixpanel · Hotjar · GitHub · Linear · n8n"],
      ["AI stack", "Claude / Claude Routines · Codex · Lovable · OpenClaw/Hermes · LLM tooling"],
      ["Mimo práci", "Rodina · sport · investování · tech inovace · cestování · historie · knihy"],
    ],
    contactLabel: "Kontakt",
    contactTitle: <>Máte nápad,<br />který chcete <em>rozjet?</em></>,
  ...
  en: {
    ...
    heroText: "I turn unclear ideas into products worth building — from discovery through MVP and delivery to launch.",
    ...
    groups: [
      ...
      ["Languages", "Czech — native speaker · English — advanced professional proficiency (B2/C1)"],
      ["Education", "University of Hradec Králové — Master’s degree / Information Management (2004–2010) · Universidad Politécnica de Madrid — Erasmus, Information Management (2009–2010)"],
      ["Certifications", "Professional Scrum Product Owner I — Scrum.org (2022) · PRINCE2 Practitioner (2015)"],
      ["Tools", "Jira · Confluence · Figma · Miro · Slack · Mixpanel · Hotjar · GitHub · Linear · n8n"],
      ["AI stack", "Claude / Claude Routines · Codex · Lovable · OpenClaw/Hermes · LLM tooling"],
      ["Outside work", "Family · sport · investing · tech innovation · travel · history · books"],
    ],
    contactLabel: "Contact",
    contactTitle: <>Have an idea<br />you want to <em>bring to life?</em></>,
