...
export const experience = {
  cs: [
    ...
    },
    {
      ...
      meta: "HPP · Praha",
      text: "Business analýza v rámci digitální transformace banky včetně migrace 1,8 milionu klientů na George. Odpovědnost za delivery a rozvoj nových funkcí digitální identity George klíč a spuštění online cestovního pojištění.",
    },
  ],
  en: [
    {
    ...
    },
    {
      ...
      text: "Business analysis supporting the bank's digital transformation, including the migration of 1.8 million clients to George. Responsibility for delivery and development of new George Key digital identity features and the launch of online travel insurance.",
    },
  ],
};
